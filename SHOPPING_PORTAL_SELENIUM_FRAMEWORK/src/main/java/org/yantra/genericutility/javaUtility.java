...
public class javaUtility {
	...
	/*
	 * public static void main(String[] args) { Random random=new Random(); int data
	 * = random.nextInt(100); // int data=new Random().nextInt(100);
	...
	/*
	 * public static void main(String[] args) String s = "123.063"; double v =
	 * Double.parseDouble(s); System.out.println(v); int a = Integer.parseInt(s);
	 * System.out.println(a); long ab = Long.parseLong(s); System.out.println(ab);
	 */
